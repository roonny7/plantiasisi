            ...
            <section className="content">
                ...
                <div className="row">
                    ...
                    <div className="small-box bg-info">
                        ...
                        <a href="#" className="small-box-footer">Más info <i className="fas fa-arrow-circle-right" /></a>
                    </div>
                    </div>
                    {/* ./col */}
                    <div className="col-lg-3 col-6">
                ...
                <div className="row">
                    ...
                    <div className="card direct-chat direct-chat-primary">
                        <div className="card-header">
                        <h3 className="card-title">Mensajería</h3>
                        <div className="card-tools">
                        ...
                        <div className="direct-chat-messages">
                            ...
                            <div className="direct-chat-infos clearfix">
                                <span className="direct-chat-name float-left">Josué Will Valencia</span>
                                <span className="direct-chat-timestamp float-right">15 Abril 2:00 pm</span>
                            </div>
                            {/* /.direct-chat-infos */}
                            ...
                            <div className="direct-chat-infos clearfix">
                                <span className="direct-chat-name float-right">Soporte</span>
                                <span className="direct-chat-timestamp float-left">15 Jan 2:05 pm</span>
                            </div>
                            {/* /.direct-chat-infos */}
                            
                            {/* /.direct-chat-img */}
                            <div className="direct-chat-text">
                                ¿Cuánto pesa su documento?
                            </div>
                            {/* /.direct-chat-text */}
                            </div>
                            {/* /.direct-chat-msg */}
                            ...
                            <div className="direct-chat-infos clearfix">
                                <span className="direct-chat-name float-left">Josué Will Valencia</span>
                                <span className="direct-chat-timestamp float-right">15 Abril 5:37 pm</span>
                            </div>
                            {/* /.direct-chat-infos */}
                            ...
                            <div className="direct-chat-infos clearfix">
                                <span className="direct-chat-name float-right">Soporte</span>
                                <span className="direct-chat-timestamp float-left">15 Abril 6:10 pm</span>
                            </div>
                            {/* /.direct-chat-infos */}
                            
                            {/* /.direct-chat-img */}
                            <div className="direct-chat-text">
                                Suba un ticket para su atención. Saludos
                            </div>
                            {/* /.direct-chat-text */}
                            </div>
                            {/* /.direct-chat-msg */}
                        ...
                        <form action="#" method="post">
                            ...
                            <input type="text" name="message" placeholder="Escriba su duda ..." className="form-control" />
                    ...
                    <div className="card">
                        ...
                        <ul className="todo-list" data-widget="todo-list">
                            ...
                            {/* todo text */}
                            <span className="text">Carga de archivos</span>
                            {/* Emphasis label */}
                            <small className="badge badge-danger"><i className="far fa-clock" /> 2 semanas</small>
                            ...
                            <span className="text">Generar respaldos</span>
                            <small className="badge badge-warning"><i className="far fa-clock" /> 1 hora</small>
                            <div className="tools">
                                <i className="fas fa-edit" />
                                <i className="fas fa-trash-o" />
                            </div>
                            ...
                            <span className="text">Retroalimentación</span>
                            <small className="badge badge-success"><i className="far fa-clock" /> 3 días</small>
                            <div className="tools">
                                <i className="fas fa-edit" />
                                <i className="fas fa-trash-o" />
                            </div>
                            ...
                            <span className="text">Carga inicial</span>
                            <small className="badge badge-primary"><i className="far fa-clock" /> 1 mes</small>
                            <div className="tools">
                                <i className="fas fa-edit" />
                                <i className="fas fa-trash-o" />
                            </div>
                            ...
                            <span className="text">Análisis de la version 2.0</span>
                            <small className="badge badge-secondary"><i className="far fa-clock" /> 1 mes</small>
                            <div className="tools">
                                <i className="fas fa-edit" />
                                <i className="fas fa-trash-o" />
                            </div>
                        ...
                        <button type="button" className="btn btn-primary float-right"><i className="fas fa-plus" /> Agregar elemento</button>
                        </div>
                    </div>
                    {/* Calendar */}
                    <div className="card bg-gradient-success">
                        ...
                        <div className="card-tools">
                            ...
                            <div className="dropdown-menu" role="menu">
                                <a href="#" className="dropdown-item">Agregar evento</a>
                                <a href="#" className="dropdown-item">Marcar completados</a>
                                <div className="dropdown-divider" />
                                <a href="#" className="dropdown-item">Ver calendario</a>
                            </div>
                            </div>
                    ...
                    {/* Map card */}
                    <div className="card bg-gradient-primary" style={{display: "none"}}>
                        <div className="card-header border-0">
                        <h3 className="card-title">
